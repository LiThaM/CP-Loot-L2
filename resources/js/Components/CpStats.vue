...
const imageProofRequired = computed(() => !!(currentCp.value?.image_proof_required));
            ...
            <template #cp_metrics>
                <div class="l2-panel p-5 rounded-lg border border-white/10 bg-gradient-to-b from-white/5 to-transparent backdrop-blur">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div class="p-4 rounded-lg border border-gray-200 bg-white/70 dark:border-emerald-500/15 dark:bg-black/20 col-span-2">
