    ...
    public function run(): void
    {
        $translations = [
            'es' => [
                ...
                ['key' => 'loot.event_types.raid_boss', 'value' => 'Raid Boss'],
                ['key' => 'loot.event_types.epic', 'value' => 'Épico'],
                ['key' => 'loot.event_types.epic_boss', 'value' => 'Epic Boss'],
                ...
                ['key' => 'nav.changelog', 'value' => 'Novedades'],
                ['key' => 'nav.logout', 'value' => 'Salir'],

                ['key' => 'changelog.title', 'value' => 'Novedades'],
                ['key' => 'changelog.subtitle', 'value' => 'Historial de cambios publicados en la web.'],
                ['key' => 'changelog.empty', 'value' => 'Aún no hay novedades publicadas.'],
                ['key' => 'changelog.type.feature', 'value' => 'Nuevo'],
                ['key' => 'changelog.type.improvement', 'value' => 'Mejora'],
                ['key' => 'changelog.type.fix', 'value' => 'Arreglo'],
                ...
                ['key' => 'party.points.reset_btn_label', 'value' => 'Reiniciar DKP'],
                ['key' => 'party.points.reset_btn_title', 'value' => 'Reiniciar los puntos DKP de todos los miembros de la CP'],
                ['key' => 'party.points.reset_swal_title', 'value' => '¿Reiniciar puntos DKP?'],
                ['key' => 'party.points.reset_swal_text', 'value' => 'Esta acción pondrá a 0 los puntos DKP de todos los miembros de la CP. El historial de Adena no se ve afectado.'],
                ['key' => 'party.points.reset_swal_confirm', 'value' => 'Sí, reiniciar'],
                ['key' => 'party.points.reset_success', 'value' => 'Puntos DKP reiniciados.'],
            ...
            'en' => [
                ...
                ['key' => 'nav.changelog', 'value' => 'What\'s new'],
                ['key' => 'nav.logout', 'value' => 'Logout'],

                ['key' => 'changelog.title', 'value' => 'What\'s new'],
                ['key' => 'changelog.subtitle', 'value' => 'Log of changes published on the site.'],
                ['key' => 'changelog.empty', 'value' => 'No updates published yet.'],
                ['key' => 'changelog.type.feature', 'value' => 'New'],
                ['key' => 'changelog.type.improvement', 'value' => 'Improvement'],
                ...
                ['key' => 'party.points.reset_btn_label', 'value' => 'Reset DKP'],
                ['key' => 'party.points.reset_btn_title', 'value' => 'Reset DKP points for every CP member'],
                ['key' => 'party.points.reset_swal_title', 'value' => 'Reset DKP points?'],
                ['key' => 'party.points.reset_swal_text', 'value' => 'This will zero the DKP points of every member in the CP. Adena history is not affected.'],
                ['key' => 'party.points.reset_swal_confirm', 'value' => 'Yes, reset'],
                ['key' => 'party.points.reset_success', 'value' => 'DKP points reset.'],
                ['key' => 'party.member.badge_leader', 'value' => 'Leader'],
