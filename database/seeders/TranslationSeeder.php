    ...
    public function run(): void
    {
        $translations = [
            'es' => [
                ...
                ['key' => 'loot.adena_split_title', 'value' => 'Split de Adena'],
                ['key' => 'loot.adena_total', 'value' => 'Total'],
                ['key' => 'loot.adena_each', 'value' => 'Cada uno'],
                ['key' => 'loot.adena_remainder_to_cp', 'value' => 'Remanente a la CP: {amount}'],
                ['key' => 'loot.adena_to_cp_title', 'value' => 'Adena a la CP'],
                ['key' => 'loot.adena_to_cp_desc', 'value' => 'Entra a la CP (warehouse): {amount}'],
                ...
                ['key' => 'party.assign_adena_offset_title', 'value' => 'Descuento de Adena'],
                ['key' => 'party.assign_member_owed', 'value' => 'Pendiente'],
                ['key' => 'party.assign_adena_offset_toggle', 'value' => 'Aplicar descuento'],
                ['key' => 'party.assign_adena_offset_amount', 'value' => 'Cantidad a descontar'],
                ['key' => 'party.assign_adena_offset_max', 'value' => 'Máximo'],
                ...
                ['key' => 'party.no_split_desc', 'value' => 'No genera split: la Adena entra a la CP.'],
                ...
                ['key' => 'party.cp_receives_adena', 'value' => 'Entra a la CP: {amount}'],
                ['key' => 'party.remainder_to_cp', 'value' => 'Remanente a la CP: {amount}'],
            ...
            'en' => [
                ...
                ['key' => 'loot.adena_split_title', 'value' => 'Adena split'],
                ['key' => 'loot.adena_total', 'value' => 'Total'],
                ['key' => 'loot.adena_each', 'value' => 'Each'],
                ['key' => 'loot.adena_remainder_to_cp', 'value' => 'Remainder to CP: {amount}'],
                ['key' => 'loot.adena_to_cp_title', 'value' => 'Adena to CP'],
                ['key' => 'loot.adena_to_cp_desc', 'value' => 'Goes to the CP (warehouse): {amount}'],
                ...
                ['key' => 'party.assign_adena_offset_title', 'value' => 'Adena offset'],
                ['key' => 'party.assign_member_owed', 'value' => 'Owed'],
                ['key' => 'party.assign_adena_offset_toggle', 'value' => 'Apply offset'],
                ['key' => 'party.assign_adena_offset_amount', 'value' => 'Offset amount'],
                ['key' => 'party.assign_adena_offset_max', 'value' => 'Max'],
                ...
                ['key' => 'party.no_split_desc', 'value' => 'No split: Adena goes to the CP.'],
                ['key' => 'party.split', 'value' => 'Split'],
                ['key' => 'party.split_desc', 'value' => 'Generates Adena owed per member.'],
                ['key' => 'party.split_members', 'value' => 'Split members'],
                ['key' => 'party.cp_receives_adena', 'value' => 'Goes to CP: {amount}'],
